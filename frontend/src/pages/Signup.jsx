        ...
        <form onSubmit={handleSubmit} className="space-y-5 relative z-10">
          <div className="space-y-1">
            ...
            <div className="relative group">
              ...
              <input type="text" className="input pl-11 py-3 text-base shadow-sm bg-white/60 dark:bg-dark-bg/60 border-slate-200/80 dark:border-dark-border/80 focus:ring-emerald-500/50 focus:border-emerald-500" placeholder="Prakhar Kumar"
